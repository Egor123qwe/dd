...
type Template interface {
	...
	Update(ctx context.Context, id string, title, type_, description, shortDescription, version, imageName, imageTag string, useGPU bool, ports []rent.Port, envs []rent.Env, volumes []string) error
}
