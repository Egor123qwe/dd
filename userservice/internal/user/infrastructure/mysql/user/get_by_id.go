...
func (r repo) GetByID(ctx context.Context, userID int) (entity.User, error) {
	...
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			return entity.User{}, fmt.Errorf("%w: user with id %d not found", errs.ErrResourceNotFound, userID)
		}
