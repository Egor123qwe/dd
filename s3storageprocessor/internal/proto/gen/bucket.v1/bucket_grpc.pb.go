...
const (
	Bucket_Create_FullMethodName = "/bucket.Bucket/Create"
)
...
type BucketClient interface {
	Create(ctx context.Context, in *BucketRequest, opts ...grpc.CallOption) (*BucketResponse, error)
}
...
func (c *bucketClient) Create(ctx context.Context, in *BucketRequest, opts ...grpc.CallOption) (*BucketResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BucketResponse)
	err := c.cc.Invoke(ctx, Bucket_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BucketServer interface {
	Create(context.Context, *BucketRequest) (*BucketResponse, error)
...
func (UnimplementedBucketServer) Create(context.Context, *BucketRequest) (*BucketResponse, error) {
...
func _Bucket_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Bucket_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BucketServer).Create(ctx, req.(*BucketRequest))
	}
